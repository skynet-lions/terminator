...
T100BinaryMerger::T100BinaryMerger(T100Code* code)
{
    //ctor
}

T100BinaryMerger::~T100BinaryMerger()
{
    //dtor
}

T100FileData* T100BinaryMerger::run(T100CODEDATA_VECTOR& files)
{
...
T100BOOL T100BinaryMerger::decide(T100SegmentCode* target, T100SegmentCode* source)
{
...
T100BOOL T100BinaryMerger::decide(T100SegmentData* target, T100SegmentData* source)
{
    if((!target) || (!source))return T100FALSE;
...
T100BOOL T100BinaryMerger::merge(T100FileData* target, T100FileData* source)
{
    T100BOOL    result      = T100FALSE;
...
T100BOOL T100BinaryMerger::mergeCode(T100SegmentCode* target, T100SegmentCode* source)
{
...
T100BOOL T100BinaryMerger::mergeData(T100SegmentData* target, T100SegmentData* source)
{
    assert(target != T100NULL);
    assert(source != T100NULL);
