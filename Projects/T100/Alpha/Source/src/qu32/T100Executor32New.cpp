#include "T100Executor32New.h"

#include "T100HintQU32.h"
#include "T100QU32New.h"
...
T100Executor32::T100Executor32(T100QU32* host)
    ...
    m_running(T100FALSE), m_paused(T100FALSE), m_step(T100FALSE), m_quit(T100FALSE)
{
    //ctor
}
...
T100VOID T100Executor32::hangup()
{
    if(m_thread){
        m_paused    = T100TRUE;
...
T100VOID T100Executor32::awaken()
{
    if(m_thread){
        m_paused    = T100FALSE;
        m_step      = T100FALSE;
